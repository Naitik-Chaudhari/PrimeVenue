        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceEstimate = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VendorServices_AspNetUsers_VendorId",
                        column: x => x.VendorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VenuePreference = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventRequests_AspNetUsers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EventRequests_SubCategories_SubCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventTemplates_AspNetUsers_OrganizerId",
                        column: x => x.OrganizerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EventTemplates_EventRequests_EventRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TemplateVendors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TemplateVendors_EventTemplates_EventTemplateId",
                        column: x => x.EventTemplateId,
                        principalTable: "EventTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TemplateVendors_VendorServices_VendorServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventRequests_SubCategoryId",
                table: "EventRequests",
                column: "SubCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_EventTemplates_EventRequestId",
                table: "EventTemplates",
                column: "EventRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_EventTemplates_OrganizerId",
                table: "EventTemplates",
                column: "OrganizerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TemplateVendors_EventTemplateId",
                table: "TemplateVendors",
                column: "EventTemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_TemplateVendors_VendorServiceId",
                table: "TemplateVendors",
